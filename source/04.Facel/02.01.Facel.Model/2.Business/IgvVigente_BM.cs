...
{
    public partial class IgvVigente_DE
    {
    }
}
namespace Facel.Business.Entities
{
    public partial class IgvVigente_BE
    {
    }
}
...
{
    public partial class IgvVigente_DA
    {	
    }
}
namespace Facel.Business.Accesses
{
    public partial class IgvVigente_BA
    {
...
{
    public partial class IgvVigente_DL
    {
        public  IgvVigente_DL(string paramEntityName = "IgvVigente",
...
{
    public partial class IgvVigente_BL
    {
    	...
    	protected override bool ValidateDelete(Entity paramDE, ref string paramField, ref string paramMessage, bool paramValidateCascadeIntegrity = true)
        {
            ...
            if (!ret)
            {
                ...
                {
    				string sCurrentTable = "El IgvVigente";
...
{
    public partial class IgvVigente_JE
    {
    }
}
namespace Facel.Filter.Entities
{
    public partial class IgvVigente_FE
    {
    }
}
...
{
    public partial class IgvVigente_JA
    {	
    }
}
namespace Facel.Filter.Accesses
{
    public partial class IgvVigente_FA
    {	
    }
}
...
{
    public partial class IgvVigente_JL
    {
        public  IgvVigente_JL(string paramEntityName = "IgvVigente",
    	string paramTableName = "igv_vigente", string paramConnectionStringName = FacelMain.ConnectionStringName)
            : base(paramEntityName,
    		paramTableName, paramConnectionStringName)
    	{
...
{
    public partial class IgvVigente_FL
    {
    }
}
