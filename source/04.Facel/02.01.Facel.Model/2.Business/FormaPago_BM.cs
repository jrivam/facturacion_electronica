...
{
    public partial class FormaPago_DE
    {
    }
}
namespace Facel.Business.Entities
{
    public partial class FormaPago_BE
    {
    }
}
...
{
    public partial class FormaPago_DA
    {	
    }
}
namespace Facel.Business.Accesses
{
    public partial class FormaPago_BA
    {
        ...
        //{
            //FormaPago_BE be = (FormaPago_BE)paramDE;
...
{
    public partial class FormaPago_DL
    {
        public  FormaPago_DL(string paramEntityName = "FormaPago",
...
{
    public partial class FormaPago_BL
    {
...
{
    public partial class FormaPago_JE
    {
    }
}
namespace Facel.Filter.Entities
{
    public partial class FormaPago_FE
    {
    }
}
...
{
    public partial class FormaPago_JA
    {	
    }
}
namespace Facel.Filter.Accesses
{
    public partial class FormaPago_FA
    {	
    }
}
...
{
    public partial class FormaPago_JL
    {
        public  FormaPago_JL(string paramEntityName = "FormaPago",
    	string paramTableName = "forma_pago", string paramConnectionStringName = FacelMain.ConnectionStringName)
            : base(paramEntityName,
    		paramTableName, paramConnectionStringName)
    	{
...
{
    public partial class FormaPago_FL
    {
    }
}
