...
{
    public partial class Documentos_Venta_DE
    {
    }
}
namespace Facel.Business.Entities
{
    public partial class Documentos_Venta_BE
    {
    }
}
...
{
    public partial class Documentos_Venta_DA
    {	
    }
}
namespace Facel.Business.Accesses
{
    public partial class Documentos_Venta_BA
    {
...
{
    public partial class Documentos_Venta_DL
    {
        public  Documentos_Venta_DL(string paramEntityName = "Documentos_Venta",
...
{
    public partial class Documentos_Venta_BL
    {
    	...
    	protected override bool ValidateDelete(Entity paramDE, ref string paramField, ref string paramMessage, bool paramValidateCascadeIntegrity = true)
        {
            ...
            if (!ret)
            {
                ...
                {
    				string sCurrentTable = "El Venta";
    				
    				if (paramField == "Serie")
                    {
                        paramField = string.Empty;
                        paramMessage = string.Format(LibraryFramework.V0006_TableDependencies, sCurrentTable, "Series");
                    }
     			}
            }
...
{
    public partial class Documentos_Venta_JE
    {
    }
}
namespace Facel.Filter.Entities
{
    public partial class Documentos_Venta_FE
    {
    }
}
...
{
    public partial class Documentos_Venta_JA
    {	
    }
}
namespace Facel.Filter.Accesses
{
    public partial class Documentos_Venta_FA
    {	
    }
}
...
{
    public partial class Documentos_Venta_JL
    {
        public  Documentos_Venta_JL(string paramEntityName = "Documentos_Venta",
    	string paramTableName = "documentos_venta", string paramConnectionStringName = FacelMain.ConnectionStringName)
            : base(paramEntityName,
    		paramTableName, paramConnectionStringName)
    	{
...
{
    public partial class Documentos_Venta_FL
    {
    }
}
