...
{
    [Serializable]
    public partial class TipoCambio_DE : EntityId
    {
    	//Fields
    	...
    	public virtual Nullable<int> IdMonedaOrigen
    	{
    		...
    		set
    		{
                if (value != _IdMonedaOrigen) 
    			{
    				...
    				if (_IdMonedaOrigen == null) MonedaOrigen = null;			
    	...
    	public virtual Nullable<int> IdMonedaDestino
    	{
    		...
    		set
    		{
                if (value != _IdMonedaDestino) 
    			{
    				...
    				if (_IdMonedaDestino == null) MonedaDestino = null;			
        ...
        public virtual Moneda_BE MonedaOrigen
    	{
    		...
    		set
    		{
    			...
    			{
    				if (_MonedaOrigen != null)
    					_MonedaOrigen.TipoCambioOrigenes.Remove((TipoCambio_BE)this);
    				if (value != null)
    					value.TipoCambioOrigenes.Add((TipoCambio_BE)this);
    				if (_MonedaOrigen != null)
    					_MonedaOrigen.TipoCambioDestinos.Remove((TipoCambio_BE)this);
    				if (value != null)
    					value.TipoCambioDestinos.Add((TipoCambio_BE)this);
        ...
        public virtual Moneda_BE MonedaDestino
    	{
    		...
    		set
    		{
    			...
    			{
    				if (_MonedaDestino != null)
    					_MonedaDestino.TipoCambioOrigenes.Remove((TipoCambio_BE)this);
    				if (value != null)
    					value.TipoCambioOrigenes.Add((TipoCambio_BE)this);
    				if (_MonedaDestino != null)
    					_MonedaDestino.TipoCambioDestinos.Remove((TipoCambio_BE)this);
    				if (value != null)
    					value.TipoCambioDestinos.Add((TipoCambio_BE)this);
...
{
    [Serializable]
    public partial class TipoCambio_BE : TipoCambio_DE
    {
    }
}
...
{
    [Serializable]
    public partial class TipoCambio_DA : AccessEntityId
    {
    	public  TipoCambio_DA(string paramTableName, string paramConnectionStringName)
...
{
    [Serializable]
    public partial class TipoCambio_BA : TipoCambio_DA
    {
    	public  TipoCambio_BA(string paramTableName, string paramConnectionStringName)
            : base(paramTableName, paramConnectionStringName)
    	{
    	}
...
{
    [Serializable]
    public partial class TipoCambio_DL : LogicEntity
    {
        protected override Access GetDA()
        {
            return new TipoCambio_DA(TableName, ConnectionStringName);
        }
    	...
    	public override byte EraseModel(Entity paramDE, bool paramCheckKeyEmpty = true, bool paramIsSourceColumn = false)
        {
    		...
    		foreach (TipoCambio_BE e in new TipoCambio_FL().LoadConvert(new TipoCambio_FL().Convert(be), 1))
    		{
     		}
    	...
    	protected override byte SaveParent(Entity paramDE, SaveStatus paramStatus, bool paramCheckKeyEmpty = true, bool paramIsSourceColumn = false)
        {
    		...
    		if (ret == 1)
                ret = new Moneda_BL().Save(be.MonedaOrigen, paramStatus, paramCheckKeyEmpty, paramIsSourceColumn);
    		if (ret == 1)
                ret = new Moneda_BL().Save(be.MonedaDestino, paramStatus, paramCheckKeyEmpty, paramIsSourceColumn);
    				
            if (ret == 1)
            {		
    			if (be.MonedaOrigen != null) be.IdMonedaOrigen = be.MonedaOrigen.Id;		
    			if (be.MonedaDestino != null) be.IdMonedaDestino = be.MonedaDestino.Id;		
    		}
...
{
    [Serializable]
    public partial class TipoCambio_BL : TipoCambio_DL
    {
        protected override Access GetDA()
        {
            return new TipoCambio_BA(TableName, ConnectionStringName);
        }		
    }
...
{
    [Serializable]
    public partial class TipoCambio_JE : EnumerateId
    {
...
{
    [Serializable]
    public partial class TipoCambio_FE : TipoCambio_JE
    {
    }
}
...
{
    [Serializable]
    public partial class TipoCambio_JA : AccessEnumerateId
    {	
    	public  TipoCambio_JA(string paramTableName, string paramConnectionStringName)
            : base(paramTableName, paramConnectionStringName)
    	{
    	}
    	...
    	public override List<Field> GetFieldsData(Enumerate paramDE, bool paramIsSourceColumn = false, 
    		string paramTableAlias = "")
        {
            TipoCambio_JE be = (TipoCambio_JE)paramDE;
    	...
    	protected override List<Field> GetFieldsJoin(List<Field> paramFields, Enumerate paramDE, int paramDepth, int paramMaxDepth = 0, bool paramIsSourceColumn = false, 
    		string paramTableAlias = "")
        {
            TipoCambio_FE be = (TipoCambio_FE)paramDE;
...
{
    [Serializable]
    public partial class TipoCambio_FA : TipoCambio_JA
    {	
    	public  TipoCambio_FA(string paramTableName, string paramConnectionStringName)
            : base(paramTableName, paramConnectionStringName)
    	{
    	}
...
{
    [Serializable]
    public partial class TipoCambio_JL : LogicEnumerate
    {
    	protected override Access GetDA()
        {
            return new TipoCambio_JA(TableName, ConnectionStringName);
        }
    	
    	public List<TipoCambio_BE> LoadConvert(Enumerate paramDE, int paramMaxDepth = 0, TypeLoad paramTypeLoad = TypeLoad.DataReader, bool paramIsSourceColumn = false,
                int paramTop = 0,
    			int paramRowFrom = 0, int paramRowTo = 0)
        {
        	return Load(paramDE, paramMaxDepth, paramTypeLoad, paramIsSourceColumn,
                    paramTop,
    				paramRowFrom, paramRowTo).ConvertAll(x => x as TipoCambio_BE);
        }
    	public TipoCambio_FE Convert(TipoCambio_BE paramDE)
        {
            TipoCambio_FE be = new TipoCambio_FE();
...
{
    [Serializable]
    public partial class TipoCambio_FL : TipoCambio_JL
    {
    	protected override Access GetDA()
        {
            return new TipoCambio_FA(TableName, ConnectionStringName);
        }
    }
}
