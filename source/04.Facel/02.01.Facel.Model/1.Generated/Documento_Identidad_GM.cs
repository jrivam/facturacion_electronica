...
{
    [Serializable]
    public partial class Documento_Identidad_DE : EntityId
    {
...
{
    [Serializable]
    public partial class Documento_Identidad_BE : Documento_Identidad_DE
    {
    }
}
...
{
    [Serializable]
    public partial class Documento_Identidad_DA : AccessEntityId
    {
    	public  Documento_Identidad_DA(string paramTableName, string paramConnectionStringName)
...
{
    [Serializable]
    public partial class Documento_Identidad_BA : Documento_Identidad_DA
    {
    	public  Documento_Identidad_BA(string paramTableName, string paramConnectionStringName)
            : base(paramTableName, paramConnectionStringName)
    	{
    	}
    	...
    	protected override Entity GetDE()
        {
            return new Documento_Identidad_BE();
        }
    }
}
...
{
    [Serializable]
    public partial class Documento_Identidad_DL : LogicEntity
    {
        protected override Access GetDA()
        {
            return new Documento_Identidad_DA(TableName, ConnectionStringName);
        }
    	...
    	public override byte EraseModel(Entity paramDE, bool paramCheckKeyEmpty = true, bool paramIsSourceColumn = false)
        {
    		...
    		foreach (Documento_Identidad_BE e in new Documento_Identidad_FL().LoadConvert(new Documento_Identidad_FL().Convert(be), 1))
    		{
     		}
...
{
    [Serializable]
    public partial class Documento_Identidad_BL : Documento_Identidad_DL
    {
        protected override Access GetDA()
        {
            return new Documento_Identidad_BA(TableName, ConnectionStringName);
        }	
    }
...
{
    [Serializable]
    public partial class Documento_Identidad_JE : EnumerateId
    {
...
{
    [Serializable]
    public partial class Documento_Identidad_FE : Documento_Identidad_JE
    {
    }
}
...
{
    [Serializable]
    public partial class Documento_Identidad_JA : AccessEnumerateId
    {	
    	public  Documento_Identidad_JA(string paramTableName, string paramConnectionStringName)
            : base(paramTableName, paramConnectionStringName)
    	{
    	}
    	...
    	public override List<Field> GetFieldsData(Enumerate paramDE, bool paramIsSourceColumn = false, 
    		string paramTableAlias = "")
        {
            Documento_Identidad_JE be = (Documento_Identidad_JE)paramDE;
    	...
    	protected override List<Field> GetFieldsJoin(List<Field> paramFields, Enumerate paramDE, int paramDepth, int paramMaxDepth = 0, bool paramIsSourceColumn = false, 
    		string paramTableAlias = "")
        {
            Documento_Identidad_FE be = (Documento_Identidad_FE)paramDE;
...
{
    [Serializable]
    public partial class Documento_Identidad_FA : Documento_Identidad_JA
    {	
    	public  Documento_Identidad_FA(string paramTableName, string paramConnectionStringName)
            : base(paramTableName, paramConnectionStringName)
    	{
    	}
...
{
    [Serializable]
    public partial class Documento_Identidad_JL : LogicEnumerate
    {
    	protected override Access GetDA()
        {
            return new Documento_Identidad_JA(TableName, ConnectionStringName);
        }
    	
    	public ObservableCollection<Documento_Identidad_BE> LoadConvert(Enumerate paramDE, int paramMaxDepth = 0, TypeLoad paramTypeLoad = TypeLoad.DataReader, bool paramIsSourceColumn = false,
                int paramTop = 0,
    			int paramRowFrom = 0, int paramRowTo = 0)
        {
        	return new ObservableCollection<Documento_Identidad_BE>(Load(paramDE, paramMaxDepth, paramTypeLoad, paramIsSourceColumn,
                    paramTop,
    				paramRowFrom, paramRowTo).ConvertAll(x => x as Documento_Identidad_BE));
        }
    	public Documento_Identidad_FE Convert(Documento_Identidad_BE paramDE)
        {
            Documento_Identidad_FE be = new Documento_Identidad_FE();
...
{
    [Serializable]
    public partial class Documento_Identidad_FL : Documento_Identidad_JL
    {
    	protected override Access GetDA()
        {
            return new Documento_Identidad_FA(TableName, ConnectionStringName);
        }
    }
}
