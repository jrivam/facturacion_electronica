...
{
    [Serializable]
    public partial class FormaPago_DE : EntityId
    {
    	//Fields
...
{
    [Serializable]
    public partial class FormaPago_BE : FormaPago_DE
    {
    }
}
...
{
    [Serializable]
    public partial class FormaPago_DA : AccessEntityId
    {
    	public  FormaPago_DA(string paramTableName, string paramConnectionStringName)
...
{
    [Serializable]
    public partial class FormaPago_BA : FormaPago_DA
    {
    	public  FormaPago_BA(string paramTableName, string paramConnectionStringName)
            : base(paramTableName, paramConnectionStringName)
    	{
    	}
...
{
    [Serializable]
    public partial class FormaPago_DL : LogicEntity
    {
        protected override Access GetDA()
        {
            return new FormaPago_DA(TableName, ConnectionStringName);
        }
    	...
    	public override byte EraseModel(Entity paramDE, bool paramCheckKeyEmpty = true, bool paramIsSourceColumn = false)
        {
    		...
    		foreach (FormaPago_BE e in new FormaPago_FL().LoadConvert(new FormaPago_FL().Convert(be), 1))
    		{
     		}
...
{
    [Serializable]
    public partial class FormaPago_BL : FormaPago_DL
    {
        protected override Access GetDA()
        {
            return new FormaPago_BA(TableName, ConnectionStringName);
        }		
    }
...
{
    [Serializable]
    public partial class FormaPago_JE : EnumerateId
    {
...
{
    [Serializable]
    public partial class FormaPago_FE : FormaPago_JE
    {
    }
}
...
{
    [Serializable]
    public partial class FormaPago_JA : AccessEnumerateId
    {	
    	public  FormaPago_JA(string paramTableName, string paramConnectionStringName)
            : base(paramTableName, paramConnectionStringName)
    	{
    	}
    	...
    	public override List<Field> GetFieldsData(Enumerate paramDE, bool paramIsSourceColumn = false, 
    		string paramTableAlias = "")
        {
            FormaPago_JE be = (FormaPago_JE)paramDE;
    	...
    	protected override List<Field> GetFieldsJoin(List<Field> paramFields, Enumerate paramDE, int paramDepth, int paramMaxDepth = 0, bool paramIsSourceColumn = false, 
    		string paramTableAlias = "")
        {
            FormaPago_FE be = (FormaPago_FE)paramDE;
...
{
    [Serializable]
    public partial class FormaPago_FA : FormaPago_JA
    {	
    	public  FormaPago_FA(string paramTableName, string paramConnectionStringName)
            : base(paramTableName, paramConnectionStringName)
    	{
    	}
...
{
    [Serializable]
    public partial class FormaPago_JL : LogicEnumerate
    {
    	protected override Access GetDA()
        {
            return new FormaPago_JA(TableName, ConnectionStringName);
        }
    	
    	public List<FormaPago_BE> LoadConvert(Enumerate paramDE, int paramMaxDepth = 0, TypeLoad paramTypeLoad = TypeLoad.DataReader, bool paramIsSourceColumn = false,
                int paramTop = 0,
    			int paramRowFrom = 0, int paramRowTo = 0)
        {
        	return Load(paramDE, paramMaxDepth, paramTypeLoad, paramIsSourceColumn,
                    paramTop,
    				paramRowFrom, paramRowTo).ConvertAll(x => x as FormaPago_BE);
        }
    	public FormaPago_FE Convert(FormaPago_BE paramDE)
        {
            FormaPago_FE be = new FormaPago_FE();
...
{
    [Serializable]
    public partial class FormaPago_FL : FormaPago_JL
    {
    	protected override Access GetDA()
        {
            return new FormaPago_FA(TableName, ConnectionStringName);
        }
    }
}
